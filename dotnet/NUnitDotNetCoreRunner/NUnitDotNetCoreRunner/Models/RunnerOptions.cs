...
namespace NUnitRunner.Models
{
    public class RunnerOptions
    {
        ...
        [Option('c', "concurrency", Required = false, HelpText = "number of concurrent users", Default = 1)]
        public int Concurrency { get; set; }

        [Option('r', "ramp_up", Required = false, HelpText = "time to ramp all concurrent users")]
        public int RampUp { get; set; }

        [Option('t', "throughput", Required = false, HelpText = "the target RPS")]
